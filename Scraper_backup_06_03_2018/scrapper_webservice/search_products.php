...
if($_SERVER['REQUEST_METHOD'] == "POST"){
   ...
   if(!empty($page_no) && !empty($results_per_page) && !empty($search_item) ) {	  
    ...
    $sql = "SELECT * FROM product where source='tottus' and (product_name like '%".$search_item."%' or product_desc like '%".$search_item."%' or brand_name like '%".$search_item."%' or category_keyword like '%".$search_item."%' or quantity_keyword like '%".$search_item."%' )".$offer_clause;
    $sql = $sql." ORDER BY product_id ASC LIMIT ". $start_from .", ".$results_per_page;
		...
		//FOR PLAZAVEA
		$sql = "SELECT * FROM product where source='plazavea' and (product_name like '%".$search_item."%' or product_desc like '%".$search_item."%' or brand_name like '%".$search_item."%' or category_keyword like '%".$search_item."%' or quantity_keyword like '%".$search_item."%')".$offer_clause;
    	$sql = $sql." ORDER BY product_id ASC LIMIT ". $start_from .", ".$results_per_page;
		...
		$sql1 = "SELECT count(*) count FROM product where product_name like '%".$search_item."%' or product_desc like '%".$search_item."%' or brand_name like '%".$search_item."%' or category_keyword like '%".$search_item."%' or quantity_keyword like '%".$search_item."%'";
