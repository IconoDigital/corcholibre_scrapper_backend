	...
	if($res["source"]=="plazavea") {
	  ...
	  if($e==0) {
	    ...
	    if($price==$offer_price)
		  ...
		  $query=$query."'".mysqli_real_escape_string($mysqli,$product_name)."','','".mysqli_real_escape_string($mysqli,$brand_name)."','".mysqli_real_escape_string($mysqli,$unit)."','".mysqli_real_escape_string($mysqli,$offer_price)."','".mysqli_real_escape_string($mysqli,$price)."','".mysqli_real_escape_string($mysqli,$offer_title)."','".mysqli_real_escape_string($mysqli,$conditions)."','".mysqli_real_escape_string($mysqli,$source)."','".mysqli_real_escape_string($mysqli,$getCatId)."','".$dateformat."','-') ON DUPLICATE KEY UPDATE 
