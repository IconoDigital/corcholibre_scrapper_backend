...
{
	foreach($a->find(".sku-rich-image-main") as $img){
	$image_src=$img->src;
 ...
 $source="vivanda";
  ...
  $query="insert into product(product_name,brand_name,unit,price,product_desc,offer_price,offer_title,offer_conditions,valid_until,source,source_category_id,url) values(";
  
  $query=$query."'".$product_name."','".$brand_name."','".$unit."','".$price."','".$product_desc."','".$offer_price."','".$offer_title."','".$offer_condition."','".$valid_until."','".$source."','".$sql_res['source_category_id']."','-') 
