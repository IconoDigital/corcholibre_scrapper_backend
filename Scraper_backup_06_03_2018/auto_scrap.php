...
while($res=mysqli_fetch_array($rs))
{
	...
	if($res["source"]=="plazavea") {
	  ...
	  $getCatId = $res["source_category_id"];
	  echo $link."\r\n\r\n";
...
`product_desc`='".mysqli_real_escape_string($mysqli,$product_description)."',brand_name='".mysqli_real_escape_string($mysqli,$brand_name)."',unit='".mysqli_real_escape_string($mysqli,$unit)."',price='".mysqli_real_escape_string($mysqli,$price)."',offer_price='".mysqli_real_escape_string($mysqli,$offer_price)."',offer_title='".mysqli_real_escape_string($mysqli,$offer_title)."',offer_conditions='".mysqli_real_escape_string($mysqli,$offer_conditions)."',source='".mysqli_real_escape_string($mysqli,$source)."',source_category_id='".mysqli_real_escape_string($mysqli,$getCatId)."',valid_until='".$dateformat."',url='+'";
	...
	$price=$price[0];
		  ...
		  $source="wong";
		  $query="insert into product(product_name,product_desc,brand_name,unit,price,offer_price,offer_title,offer_conditions,source,source_category_id,valid_until,url) values("; //str_to_date('".$date."','%d-%m-%Y')
		  $query=$query."'".mysqli_real_escape_string($mysqli,$product_name)."','','".mysqli_real_escape_string($mysqli,$brand_name)."',
		  '".mysqli_real_escape_string($mysqli,$unit)."','".mysqli_real_escape_string($mysqli,$price)."',
		  '".mysqli_real_escape_string($mysqli,$offer_price)."','".mysqli_real_escape_string($mysqli,$offer_title)."',
		  '".mysqli_real_escape_string($mysqli,$conditions)."','".mysqli_real_escape_string($mysqli,$source)."',
		  '".mysqli_real_escape_string($mysqli,$getCatId)."','".$dateformat."','-') ON DUPLICATE KEY UPDATE 
        `product_desc`='".''."',brand_name='".mysqli_real_escape_string($mysqli,$brand_name)."',product_name='".mysqli_real_escape_string($mysqli,$product_name)."',unit='".mysqli_real_escape_string($mysqli,$unit)."',price='".mysqli_real_escape_string($mysqli,$price)."',offer_price='".mysqli_real_escape_string($mysqli,$offer_price)."',offer_title='".mysqli_real_escape_string($mysqli,$offer_title)."',offer_conditions='".mysqli_real_escape_string($mysqli,$conditions)."',source='".mysqli_real_escape_string($mysqli,$source)."',source_category_id='".mysqli_real_escape_string($mysqli,$getCatId)."',valid_until='".$dateformat."',url='+'";
		  $scrap[]=  "<br>Query:".$query;
